...
func (c *Client) InsertCNAME(name, host, zone, target string, ttl int) (r *dns.Msg, tt time.Duration, err error) {
...
func (c *Client) RemoveCNAME(name, host, zone, target string, ttl int) (r *dns.Msg, tt time.Duration, err error) {
	req := fmt.Sprintf("%s %d CNAME %s", fqdnJoin(name, zone), ttl, dns.Fqdn(target))
...
func (c *Client) UpdateCNAME(name, host, zone, oTarget, nTarget string, ttl int) (r *dns.Msg, tt time.Duration, err error) {
